...
function Profile(props) {
  ...
  const defaultBackgroundUrl =
    "https://img2.pngio.com/default-png-5-png-image-default-png-1200_800.png";
  const defaultAvatarUrl =
    "https://img2.pngio.com/index-of-wp-content-themes-fgm21-child-assets-images-default-png-495_495.png";
      ...
      <div className="profile__main">
        <div className="container">
          <BoxInfo
            ...
            isMe={getUserInfo.id === userId ? true : false}
          />
